...
INSTALL_NAME_DIR=
SRC_PATH=/c/fork/synthizer3d/vcpkg_installed/vcpkg/blds/ffmpeg/src/n7.1.1-07cb3aa68a.clean
SRC_LINK=/c/fork/synthizer3d/vcpkg_installed/vcpkg/blds/ffmpeg/src/n7.1.1-07cb3aa68a.clean
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler versione 19.44.35207.1 per x64
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=
CC=cl.exe
...
CFLAGS=@C:/fork/synthizer3d/vcpkg_installed/vcpkg/blds/ffmpeg/x64-windows-dbg/cflags.rsp -nologo -DHAVE_UNISTD_H=0 /std:c17 -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O1   -utf-8
CXXFLAGS=  -D__STDC_CONSTANT_MACROS /std:c++11
OBJCCFLAGS= -nologo 
ASFLAGS=@C:/fork/synthizer3d/vcpkg_installed/vcpkg/blds/ffmpeg/x64-windows-dbg/cflags.rsp -nologo -DHAVE_UNISTD_H=0 -Z7
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m64 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include /c/fork/synthizer3d/vcpkg_installed/vcpkg/blds/ffmpeg/src/n7.1.1-07cb3aa68a.clean/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-Fo$@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
WINDRES=rc.exe
DOXYGEN=doxygen
LDFLAGS=@C:/fork/synthizer3d/vcpkg_installed/vcpkg/blds/ffmpeg/x64-windows-dbg/ldflags.rsp -libpath:C:/fork/synthizer3d/vcpkg_installed/x64-windows/debug/lib -nologo    -debug
LDEXEFLAGS=
LDSOFLAGS=
